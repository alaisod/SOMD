...
<?php
// Determine the current route so sidebar links can be highlighted dynamically.
$isHome      = url_is('/');
$isStarter   = $isHome || url_is('starter');
$isDashboard = $isHome || url_is('dashboard*');
?>
    <!--begin::Sidebar Brand-->
            ...
            >
                <li class="nav-item<?= $isDashboard ? ' menu-open' : '' ?>">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?= site_url('/') ?>" class="nav-link<?= $isDashboard ? ' active' : '' ?>">
                ...
                <li class="nav-item">
                    <a href="<?= site_url('/') ?>" class="nav-link<?= $isStarter ? ' active' : '' ?>">
